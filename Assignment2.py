# -------------------------------
# Mall Customers Multivariable Regression Model
...
plt.title("Actual vs Predicted Spending Score (Random Forest)")
plt.grid(True)
plt.show()
...
plt.figure(figsize=(8,6))
sns.heatmap(data[['Genre', 'Age', 'Annual Income (k$)', 'Spending Score (1-100)']].corr(), annot=True, cmap='coolwarm')
